...
> #24–#26 為 2026-09-12 全輪 final code review（verdict APPROVED）回報的 Nit 級新債；第四項 Nit（collapse 亦觸發
> refetch）經查在 ≤1 query/account/5-min 上限內屬既知行為，非債。
> 2026-09-12 存量債清理輪：#20–#26 全數清償（操作者指示後逐項 TDD/實測，見 FIX-LOG 同日第二則）。
